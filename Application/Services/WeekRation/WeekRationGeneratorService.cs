...
public sealed class WeekRationGeneratorService : IWeekRationGeneratorService
{
    ...
    private const string SystemPrompt =
        ...
        16. Строго соблюдай правила классификации блюд по приёмам пищи:
           - **Завтрак (breakfast):** допустимы только типичные завтраки: каши, омлеты, яйца, творог, йогурт, сырники, запеканки, тосты, сэндвичи для завтрака, блины, гранола, фрукты. Запрещены блюда, типичные для обеда или ужина: котлеты, жаркое, плов, шашлык, стейки, тяжёлые супы, вторые блюда с гарниром, макароны по-флотски и аналогичное.
           - **Обед (lunch):** допустимы супы, горячие основные блюда, мясо/рыба/птица с гарниром, паста, рагу, салат плюс основное и т.п. Обед должен быть **самым сытным** приёмом пищи за день.
           - **Ужин (dinner):** допустимы лёгкие или умеренно сытные блюда: рыба, курица, омлет, творог, овощи, салаты с белком, тушёные блюда, лёгкие супы и т.п. Ужин **не должен быть тяжелее обеда** (ни по составу товаров в смысле «обеденности», ни по калорийности относительно обеда в тот же день, ориентируясь на заданные ккал по приёмам).
           - **Перекус (snack):** лёгкие порции между основными приёмами: фрукты, йогурт/творог, орехи или сухофрукты в умеренном количестве, батончик, сыр, овощи, небольшой сэндвич; не помещай сюда полноценный «обед» или тяжёлый «ужин» из каталога.
        17. Если блюдо не соответствует своему приёму пищи по смыслу — **не предлагай** его в этом слоте; **автоматически замени** на подходящий товар из каталога (включая замены в replace).
        18. Перед финальным ответом выполни **самопроверку**: завтрак выглядит как завтрак; обед — как обед; перекус — как перекус; ужин — как ужин. При любом нарушении исправь слот до отправки JSON.
